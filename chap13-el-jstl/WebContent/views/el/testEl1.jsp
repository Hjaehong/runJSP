...
<body>
	...
	<p>
		EL은 get을 통해 값을 빼올 필요 없이 키값만 제시해서 바로 접근 가능 <br> 내부적으로 해당 객체의
		getXXX을 자동적으로 활용하여 해당 키에 저장된 밸류값을 읽음 <br>
		<br> EL은 request, session 등 JSP 내장 객체를 구분하지 않아도 <br> 자동으로
		입력된 속성명(키값)을 검색하여 존재하는 경우 값을 가져옴
	</p>
